        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h1><i class="fa fa-clock-o fa-fw w3-margin-right" style="font-size: 42px"></i><b>동호회 상세보기</b></h1><hr>
	            <table border="1" class="cmtTB" style="align-content: center;">
					...
					<tr>
						<td colspan="2">
							<input class="btn2" type="button" value="목록" onclick="location.href='clubList'">
							<c:if test="${detail_num == emp_num }">
								<input class="btn2" type="button" value="수정" onclick="location.href='clubupdateForm?rr_num=${jhRr.rr_num }&detail_num=${jhRr.emp_num}'">			
								<input class="btn2" type="button" value="삭제" onclick="location.href='clubdelete?rr_num=${jhRr.rr_num }&detail_num=${jhRr.emp_num}'">
							</c:if>
						</td>
					</tr>
				</table>
