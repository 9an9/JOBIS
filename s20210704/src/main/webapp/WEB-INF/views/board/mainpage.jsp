...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">
      <a href="noticeList" class="w3-bar-item w3-button">공지사항</a>
      <a href="surveyList" class="w3-bar-item w3-button">설문</a>
...
<div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <button onclick="myFunction1('Demo2')" class="w3-bar-item w3-button w3-padding-large">게시판</button>
  	<div id="Demo2" class="w3-hide w3-bar-block">
    	<a href="noticeList" class="w3-button w3-block w3-theme-l5 w3-left-align">공지사항</a>
        <a href="surveyList" class="w3-button w3-block w3-theme-l5 w3-left-align">설문조사</a>
        <a href="clubList" class="w3-button w3-block w3-theme-l5 w3-left-align">동호회</a>
    </div>
    <c:if test="${svo.dcontent == '인사부' || svo.dcontent == '임원'  }">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
          ...
          <a href="surveyList" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-check-square-o fa-fw w3-margin-right"></i><span class="w3-badge w3-right w3-small w3-green">2</span> 설문</a>
        </div>      
      </div>
      <br>
