            ...
            <div class="w3-container w3-padding">
              <h1><i class="fa fa-clock-o fa-fw w3-margin-right" style="font-size: 42px"></i><b>공지사항 상세보기</b></h1><hr>
	            <table border="1" class="cmtTB" style="align-content: center; border: none;">
						<tr>
							<td style="background-color:#E0E3DA; color: white; ">사원번호</td>
							<td>${jhRr.emp_num }</td>			
						</tr>
						<tr>
							<td style="background-color:#E0E3DA; color: white; ">자료종류</td>
							<td>
						...
						<tr>
							<td style="background-color:#E0E3DA; color: white; ">제목</td>
							<td>${jhRr.rr_subject }</td>			
						</tr>
						<tr>
							<td style="background-color:#E0E3DA; color: white; ">내용</td>
							<td>${jhRr.rr_content }</td>			
						</tr>
						<tr>
							<td style="background-color:#E0E3DA; color: white; ">작성일</td>
							<td>${jhRr.rr_date }</td>			
						</tr>
					<tr>
						<td colspan="2">
