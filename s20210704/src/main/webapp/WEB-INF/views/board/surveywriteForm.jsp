        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h1><i class="fa fa-clock-o fa-fw w3-margin-right" style="font-size: 42px"></i><b>설문조사 등록하기</b></h1><hr>
	          
				
				<form action="surveywrite" method ="post">
			
				<input type="hidden" name="emp_num" value="${emp_num }">
				<input type="hidden" name ="survey_num" value="${survey_num }">
				<select name="survey_ques_id" style="height: 40px; width: 10%;">
		          			<option value="0">객관식</option>
		          			<option value="1">주관식</option>
	          	</select>	          
	          	<input type="text" placeholder="설문 제목" name="survey_title"><p>
	          	<input type="text" placeholder="질문내용" name="survey_ques_content"><p>
	          	<input type="date" placeholder="시작날짜" name="survey_stdate"><p>
	          	<input type="date" placeholder="마감날짜" name="survey_fndate"><p>
	          	<div><input class="btn2" type="submit" value="설문등록하기"></div>
