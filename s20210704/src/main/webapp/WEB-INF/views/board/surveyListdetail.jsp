        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h1><i class="fa fa-clock-o fa-fw w3-margin-right" style="font-size: 42px"></i><b>설문조사</b></h1><hr>
	         <form action ="surveyanswwrite" method="post">
	         ...
	         <input type="hidden" name="survey_num" value="${survey_num }">
	          ...
	          <table border="1" class="cmtTB" style="align-content: center;">
				<tr>
				<th class="regdate_width">설문 번호 : ${sySurvey.survey_num}</th>
				<th class="regdate_width">설문 제목 : ${sySurvey.survey_title}</th>
				
			</tr>
			 
			<tr>
				<th colspan="2" >설문기간: ${sySurvey.survey_stdate}~${sySurvey.survey_fndate}</th>
				
				
			</tr>
				<tr>
				
				<th colspan="2" class="regdate_width">${sySurvey.survey_ques_content}</th>
				
			</tr>
			
				<c:if test="${sySurvey.survey_ques_id == 0 }">
				<tr>
				<th><input id ="yes" type="radio" name="survey_answ_content"value="yes"class="regdate_width">
				<label for="yes">예</label></th>
				<th><input id ="no" type="radio" name="survey_answ_content"value="no"class="regdate_width">
				<label for="no">아니오</label></th>
			</tr>
				</c:if>
			<tr>	
				<c:if test="${sySurvey.survey_ques_id ==1 }">
				<th><input type="text" placeholder="답변내용" name="survey_answ_content"></th>
				</c:if>
			</tr>
			
			<tr ><th colspan="2"><input type ="submit" value="제출"></th></tr>
